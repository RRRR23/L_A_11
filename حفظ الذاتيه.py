...
ZelzalSelf_cmd = (
    "𓆩 [ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝗥𝗨𝗡𝗧𝗛𝗢𝗡 - حفـظ الذاتـيـة ♥️](t.me/xLxLxLrr) 𓆪\n\n"
    "**⪼** `.تفعيل الذاتيه`\n"
    ...
    "\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗥𝗨𝗡𝗧𝗛𝗢𝗡](t.me/xLxLxLrr) 𓆪"
)
