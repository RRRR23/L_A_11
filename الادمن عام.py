...
zel_dev = (6186856384, 24515944815)
...
async def startgmute(event):
    ...
    if event.is_private:
        ...
        if user.id == 6186856384 or user.id == 1895219306 or user.id == 2095357462:
...
async def catgkick(event):  # sourcery no-metrics
    ...
    if user.id == 6186856384 or user.id == 189519306 or user.id == 25535554562:
