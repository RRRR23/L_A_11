...
ZelzalCoins_cmd = (
    "[ᯓ 𝘀𝗼𝘂𝗿𝗰𝗲 𝗥𝘂𝗻𝘁𝗵𝗼𝗻 - أوامـر تجميـع النقـاط](t.me/xLxLxLrr) 𓆪\n\n"
    "**𓆰 قـائمـة أوامـر تجميـع نقـاط بوتـات تمـويـل الخاص بسـورس رنثـون🦾 :** \n\n"
    "`.المليار`\n"
    ...
    "`.راتب وعد 50`\n\n\n"
    "**- مـلاحظــه :**\n"
    "**⪼ سيتم اضـافـه المزيـد من البوتـات بالتحديثـات الجايـه .. إذا تريـد اضافـة بـوت محـدد راسـل مطـور السـورس @L_A_1**"
)
