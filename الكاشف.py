#𝐑𝐔𝐍𝐓𝐇𝐎𝐍  ®
#الملـف حقـوق وكتابـة علش الهيبـه ⤶ @L_A_1 خاص بسـورس ⤶ 𝐑𝐔𝐍𝐓𝐇𝐎𝐍 
...
ZelzalPH_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗥𝘂𝗻𝘁𝗵𝗼𝗻 𝗖𝗼𝗻𝗳𝗶𝗴 📲 - كـاشـف الأرقـام العربيــة](t.me/xLxLxLrr) 𓆪\n\n"
    "**⪼ الأمــر ↵**\n\n"
...
async def _(event):
    ...
    chat = "@alhber192_bot"
    L_A_1 = await edit_or_reply(event, "**╮•⎚ جـارِ الكـشف ؏ــن الـرقـم  📲 ⌭ . . .**")
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await L_A_1.edit("**╮•⎚ تحـقق من أنـك لم تقـم بحظر البوت @alhber192_bot .. ثم اعـد استخدام الأمـر ...🤖♥️**")
            return
        if response.text.startswith("I can't find that"):
            await L_A_1.edit("**عـذرًا مـطـوري لم أقـدر على مـعرفة نـوع الـرقـم**")
        else:
            await L_A_1.delete()
