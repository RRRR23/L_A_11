# Zed-Thon - ZelZal
# Copyright (C) 2023 xLxLxLrr . All Rights Reserved
#
# This file is a part of < https://github.com/Zed-Thon/ZelZal/ >
# PLease read the GNU Affero General Public License in
# <https://www.github.com/Zed-Thon/ZelZal/blob/main/LICENSE/>.
""" 
Logo & Style for ZThon™ t.me/xLxLxLrr
Write file by Zelzal t.me/L_A_1
...
async def lg1(userevent):
    ...
    if gvarstatus("ZED_FONTS") is None: # code by t.me/L_A_1
    ...
    if arabic_text: # code by t.me/L_A_1
...
async def lg1(userevent):
    ...
    if not arabic_text: # code by t.me/L_A_1
