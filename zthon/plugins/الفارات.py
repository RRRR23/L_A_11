...
حقـوق للتـاريخ : @xLxLxLrr
@L_A_1 - كتـابـة الملـف :  علش """
#علش وصوفي سندي
import asyncio
import math
import os
...
ZelzalVP_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗘𝗹𝗹𝗼𝗿𝘆 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر الفـارات](t.me/xLxLxLrr) 𓆪\n\n"
    ...
    "⪼ `.وقت المغرب` \n\n"
    "⪼ `.وقت تركيا` \n\n"
    "🛃 سيتـم إضـافة المزيـد من الدول قريبـًا\n\n"
    "\n𓆩 [ 𝙑𝙖𝙧𝙨 - قنـاة الفـارات](t.me/xLxLxLrr3) 𓆪"
)
...
async def variable(event):
    ...
    vinfo = reply.text
    zed = await edit_or_reply(event, "**❈╎جـاري إضـافة الفـار الـى بـوتك ...**")
...
async def custom_zed(event):
    ...
    if (input_str == "كليشة الحماية" or input_str == "كليشة الحمايه" or input_str == "كليشه الحماية" or input_str == "كليشه الحمايه"):
        ...
        if variable is None:
            ...
            await zed.edit("**❈╎الفـار {} موجـود ☑️**\n**❈╎قيمـة الفـار : ↶**\n `{}` \n\n**❈╎قنـاة السـورس : @xLxLxLrr**".format(input_str, variable))
...
async def variable(event):
    ...
    viran = "Asia/Tehran"
    heroku_var = app.config()
    zed = await edit_or_reply(event, "**❈╎جـاري أعـداد المنطقـه الزمنيـةلـ رنثـون🌐...**")
    # All Rights Reserved for "Zed-Thon" "علش الهيبـه"
...
async def _(malatha):
    if malatha.fwd_from:
        return
    zed = await edit_or_reply(malatha, "**❈╎جـاري إضـافة فـار الصـورة الـى بـوتك ...**")
    ...
    if malatha.reply_to_msg_id:
        ...
        if input_str in ["الحماية", "الحمايه"]:
            ...
            try:
                ...
                await zed.edit("**❈╎تم تغييـر صـورة {} .. بنجـاح ☑️**\n**❈╎المتغيـر : ↶**\n `{}` \n\n**❈╎قنـاة السـورس : @xLxLxLrr**".format(input_str, vinfo))
