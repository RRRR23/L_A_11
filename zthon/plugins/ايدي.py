...
#
# This file is a part of < https://github.com/xLxLxLrr/ZelZal/ >
# PLease read the GNU Affero General Public License in
# <https://www.github.com/xLxLxLrr/ZelZal/blob/main/LICENSE/>.

"""
𝐑𝐔𝐍𝐓𝐇𝐎𝐍 - Ali
- كتـابـة الاضـافـات
علش الـهيبــه - @L_A_1
- حقـوق رنثـون @xLxLxLrr
...
# code by t.me/L_A_1
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت رنثـون"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ 𝐑𝐔𝐍𝐓𝐇𝐎𝐍  ─┄─┄─┄─⋆"
...
# Copyright (C) 2021 xLxLxLrr . All Rights Reserved
# الـرتب الوهميـه & البريميـوم كتـابـة الكـود - علش الـهيبــه @L_A_1
    if user_id in zelzal: # code by t.me/L_A_1
    ...
    if zilzal == True or user_id in zelzal: # code by t.me/L_A_1
        caption += f"<b>{ZEDM}الحسـاب ⇠  بـريميـوم 🌟</b>\n"
    caption += f"<b>{ZEDM}الصـور    ⇠ </b> {replied_user_profile_photos_count}\n"
    if user_id != (await event.client.get_me()).id: # code by t.me/L_A_1
