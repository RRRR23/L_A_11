...
async def _ban_person(event):
    ...
    if user.id == 6186856384 or user.id == 1895739306 or user.id == 2374357462:
...
async def startmute(event):
    ...
    if event.is_private:
        ...
        if event.chat_id == 6186856384 or event.chat_id == 1895219306 or event.chat_id == 2095357462:
