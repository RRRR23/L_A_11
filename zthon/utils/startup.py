    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                caption="**•⎆┊تـم بـدء تشغـيل سـورس رنثـون الخاص بك .. بنجاح 🧸♥️**",
                
                buttons=[(Button.url("𝗘𝗟𝗟𝗢𝗥𝗬", "https://t.me/xLxLxLrr"),)],
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", "RunThon")
            ...
            await bot.send_message("@BotFather", f"- بـوت رنثـون المسـاعـد ♥️🦾 الخـاص بـ  {bot.me.first_name} ")
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/thon.jpg")
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/Run.jpg")
